...
module CovidTracker
  class ByRegionPagesGeneratorService
    ...
    class << self
      ...
      def perma_link(central_area_code:, region_code:)
    ...
    private
      ...
      def file_parts(central_area_code:, region_code:, file_type:)
        parts = {}
...
folder: #{folder(region_code)}/
---
"
    end

    def folder(region_code)
...
"
    ...
    def graph_weekly_path(region_code)
      "/images/graphs/#{region_code}#{CovidTracker::WeeklyPagesGeneratorService::FILE_POSTFIX}_graph.png"
    end
