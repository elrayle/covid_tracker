module CovidTracker
  class Result
    ...
    attr_accessor :id, :result_code, :result_label, :date, :cumulative_confirmed,
                  :delta_confirmed, :cumulative_deaths, :delta_deaths,
                  :rolling_7_days_confirmed, :rolling_7_days_deaths, :error
    ...
    def self.for(raw_result)
      ...
      result.rolling_7_days_confirmed = -1
      result.rolling_7_days_deaths = -1
      result
    end
    ...
    def self.parse_result(count_data:)
      ...
      result.rolling_7_days_confirmed = count_data.rolling_7_days_confirmed
      result.rolling_7_days_deaths = count_data.rolling_7_days_deaths
      result
    end
